...
class AuthRoutesTest(unittest.TestCase):
    ...
    def test_login_invalid_credentials(self, mock_find_user):
        ...
        response = self.client.post("/auth/login", json={"username": "testuser", "password": "wrongpass"})
    ...
    def test_register_success(self, mock_save):
        ...
        response = self.client.post("/auth/register", json={"username": "newuser", "password": "newpass"})
    ...
    def test_register_username_exists(self, mock_save):
        ...
        response = self.client.post("/auth/register", json={"username": "existinguser", "password": "pass"})
